...
const ClientsPage: React.FC = () => {
  ...
  const [formData, setFormData] = useState({ name: '', description: '', department: '', email: '', phone: '' });
  ...
  const createMutation = useMutation({
    mutationFn: (clientData: { name: string; description?: string; department?: string; email?: string; phone?: string }) =>
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: number; data: { name?: string; description?: string; department?: string; email?: string; phone?: string } }) =>
  ...
  const handleOpen = (client?: Client) => {
    if (client) {
      ...
      setFormData({ name: '', description: '', department: '', email: '', phone: '' });
    }
    setError('');
    setOpen(true);
  };
